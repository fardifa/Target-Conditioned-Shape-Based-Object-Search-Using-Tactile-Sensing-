...
MODEL_XML  = os.path.join(SCRIPT_DIR, "scene_square.xml")
BODY_NAME  = "cube"
...
def main():
    print("🚀 Starting tactile square simulation (stable contact + 3D logging)")
    ...
    # --- Dataset setup ---
    save_dir = os.path.join(SCRIPT_DIR, "dataset", "square")
    ...
    with mujoco.viewer.launch_passive(model, data) as viewer:
        while viewer.is_running():
            ...
            if phase == "forward":
                ...
                # Maintain light pressure to prevent loss of contact
                if f_val < FORCE_THR:
                    data.qpos[x_idx] -= NUDGE_X * 2
                else:
                    data.qvel[x_idx] = 0.0
                ...
                # Smooth deterministic rotation pattern
                ...
                # Add small side oscillation in Y
    ...
    print(f"✅ Tactile square data saved to: {csv_path}")
